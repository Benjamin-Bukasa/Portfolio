...
function Experience() {
  ...
  return (
    <div className="w-full px-20 flex justify-center items-center gap-40 py-20 bg-white">
        ...
        <div className="w-1/3 flex flex-col justify-start items-start gap-12 p-2 ">
            <div className="">
