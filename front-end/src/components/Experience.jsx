    ...
    <div className="w-full px-10 flex justify-center items-center gap-20 py-20 bg-white">
        ...
        <div className="w-2/4 flex flex-col justify-start items-start gap-12 p-6">
            ...
            <div className="w-full flex justify-start items-center gap-10">
                <button className="w-1/3 p-2 bg-[#cf6f77] hover:bg-[#B9525B] font-semibold text-white">Prendre un rendez-vous</button>
                <div className="w-1/3 flex justify-start items-center gap-4">
                    <Link to='/gmail'><SiGmail size={25}/></Link>
                    <Link to='/linkedin'><FaLinkedin size={25}/></Link>
                    <Link to='/twitter'><FaSquareXTwitter size={25}/></Link>
                    <Link to='/facebook'><FaSquareFacebook size={25}/></Link>
                </div>
            </div>
        </div>
    </div>
