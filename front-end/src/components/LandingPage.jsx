...
function LandingPage() {
  ...
  return (
    <div className='w-full px-20 vsm:px-10 vsm:text-center py-0 flex flex-wrap justify-center items-end gap-1 font-normal font-poppins bg-white vsm:w-full'>
        <div className="absolute w-1/4 h-full right-0 bg-[#eb9b9e42] z-0 border lg:block vsm:hidden"></div>
        <div className="smd:w-1/2 h-[80%] flex flex-col justify-start items-start gap-10 p-2 py-5 vsm:w-full">
            ...
            <p className="smd:text-left w-3/4 vsm:w-full">Concepteur des sites et applications web fluide, élégant avec des interfaces qui attires plus des prospects </p>
